...
echo "building image cfnodejsapp"
pushd source\pcf-sample-code-main\pcf-sample-code-main\cloud-foundry\cfnodejsapp
%CONTAINER_RUNTIME% build -f Dockerfile -t cfnodejsapp .
popd
